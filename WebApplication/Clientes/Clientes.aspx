...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row justify-content-center">
        <div class="col-auto p-2 mb-4 justify-content-center">
            ...
            <asp:Repeater ID="RepeaterClientes" runat="server">
                <ItemTemplate>
                    <div    class="card border rounded-3" 
                            style="width: 18rem; margin:8px; padding:3px; cursor:pointer;">

                        <div    class="card-body" 
                                onclick="redirecionarParaPaginaDoCliente('<%= Session["Perfil"].ToString() %>', <%#DataBinder.Eval(Container.DataItem, "Id") %>)">
